...
uint256 hashGenesisBlock("0x000000004664df1d76183b806d83b5ab36e88ce27876db3197ef765ebac66644");
...
const string strMessageMagic = "FiftyShadesOfCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000004664df1d76183b806d83b5ab36e88ce27876db3197ef765ebac66644");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1424791172;
        block.nBits    = 486604799;
        block.nNonce   = 350973122;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FiftyShadesOfCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FiftyShadesOfCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("FiftyShadesOfCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running FiftyShadesOfCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FiftyShadesOfCoinMiner terminated\n");
        throw;
    }
}
